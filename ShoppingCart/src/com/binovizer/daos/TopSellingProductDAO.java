...
public class TopSellingProductDAO {
	public static ArrayList<ProductDTO> getTopSellingProductList(){
		...
		try{
			...
			pstmt = con.prepareStatement("select product_id,product_name,product_price,product_discount,item_id from products where product_status=? AND product_keywords LIKE ? LIMIT 4");
			pstmt.setString(1, "A");
